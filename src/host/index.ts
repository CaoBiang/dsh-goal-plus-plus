/**
 * dsh-goal-plus-plus — Host half (installed package entry).
 *
 * A plain Cordis plugin module (ESM) loaded by the harness as the
 * `dsh-goal-plus-plus` loader row. Since v0.9 the Host half is built on *projection
...
export const name = 'dsh-goal-plus-plus'
