 ...
 * 0.1.2-rc.1+. The newest checked surface is 0.1.6-alpha.2. On it, the session-projection registry drives the unit
 ...
 * (0.1.6-alpha.2), whose `wire?` is optional; this plugin's units are always
