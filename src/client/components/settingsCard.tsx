/**
   * The dsh-goal-plus-plus card in Settings → Plugins → Plugin configuration,
   * registered on the framework's `settings.plugin.item` slot keyed on the
   * Host-served `dsh-goal-plus-plus` settings namespace — the section itself
   * supplies nothing; it renders nothing while the namespace is unavailable
