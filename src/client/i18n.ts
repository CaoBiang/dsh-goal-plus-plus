...
export const DICT_ZH: Record<string, string> = {
  ...
  'goal.tokens': '目标 Token 统计', 'goal.currentTokens': '当前轮次上下文',
  'goal.tokenTrend': '每轮上下文花费', 'goal.tokenRound': '第 {t} 轮',
  ...
  'goal.filesHint': '按目标轮次中的成功文件操作累计估算行数，并非 Git 净差异。',
  'goal.filesPartial': '较早的操作记录已超出保留范围，当前仅显示保留记录中的改动。',
  'goal.pause': '暂停', 'goal.resume': '启动', 'goal.controlPending': '处理中…',
  ...
  'goal.details': '目标详情', 'goal.stateChart': '目标状态图谱',
  'goal.currentState': '当前状态', 'goal.stateSummary': '当前目标状态：{phase}',
  'goal.stateChartHint': '高亮当前状态，其他节点为可用状态；连线不表示历史迁移。',
  'goal.phaseHint.active': '目标仍在进行。自动续跑是否启用由宿主另行决定。',
  'goal.phaseHint.paused': '目标已暂停，可点击“启动”或在聊天中通过 /goal resume 继续。',
  'goal.phaseHint.blocked': '目标受阻，请先查看并解决上方的受阻原因。',
  'goal.phaseHint.complete': '宿主已将此目标记录为完成。',
  'goal.budgetChart': '目标轮次用量', 'goal.roundShare': '轮次已用',
  'goal.started': '已启动', 'goal.remaining': '剩余额度',
  'goal.budgetSummary': '轮次上限 {limit}，已启动 {started}，剩余额度 {remaining}',
  'goal.budgetUnknown': '轮次数据缺失或不一致，暂不计算比例。',
  'goal.capReached': '已达到轮次上限；这不代表目标已经完成。',
  'goal.roundChart': '轮次分布', 'goal.roundPosition': '已启动 {n} 轮',
  'goal.bin': '第 {first}–{last} 轮，已启动 {used} 轮',
  'goal.roundChartHint': '彩色表示已启动轮次，灰色表示未使用额度。较大的上限按区间合并展示；悬停可查看区间数值。',
  ...
  'goal.rounds': '已启动轮次', 'goal.limit': '轮次上限',
  'goal.created': '创建时间', 'goal.updated': '更新时间',
  'goal.id': '目标 ID', 'goal.revision': '修订版本',
  'goal.roundsHint': '轮次表示已启动的目标执行轮数，不代表完成进度。',
  'goal.durableHint': '显示宿主记录的目标状态；“进行中”不代表当前正在自动续跑。',
  'tab': '上下文',
...
export const DICT_EN: Record<string, string> = {
  ...
  'goal.tokens': 'Goal Token stats', 'goal.currentTokens': 'Current round context',
  'goal.tokenTrend': 'Context per round', 'goal.tokenRound': 'Round {t}',
  ...
  'goal.filesHint': 'Estimated cumulative lines from successful file operations in goal rounds, not a net Git diff.',
  'goal.filesPartial': 'Earlier operations exceeded retention. Only changes in retained records are shown.',
  'goal.pause': 'Pause', 'goal.resume': 'Start', 'goal.controlPending': 'Working…',
  ...
  'goal.details': 'Goal details', 'goal.stateChart': 'Goal state map',
  'goal.currentState': 'Current state', 'goal.stateSummary': 'Current goal state: {phase}',
  'goal.stateChartHint': 'The current state is highlighted among the available states. Lines do not represent transition history.',
  'goal.phaseHint.active': 'The goal is active. Automatic continuation is controlled separately by the host.',
  'goal.phaseHint.paused': 'The goal is paused. Select Start or use /goal resume in chat to continue.',
  'goal.phaseHint.blocked': 'The goal is blocked. Review and resolve the reason above first.',
  'goal.phaseHint.complete': 'The host has recorded this goal as complete.',
  'goal.budgetChart': 'Goal round usage', 'goal.roundShare': 'Rounds used',
  'goal.started': 'Started', 'goal.remaining': 'Remaining allowance',
  'goal.budgetSummary': 'Round limit {limit}, started {started}, remaining allowance {remaining}',
  'goal.budgetUnknown': 'Round data is missing or inconsistent; proportions are unavailable.',
  'goal.capReached': 'The round limit has been reached. This does not mean the goal is complete.',
  'goal.roundChart': 'Round distribution', 'goal.roundPosition': '{n} rounds started',
  'goal.bin': 'Rounds {first}–{last}, {used} started',
  'goal.roundChartHint': 'Color marks started rounds; gray marks unused allowance. Larger limits are grouped into ranges. Hover for range counts.',
  ...
  'goal.rounds': 'Rounds started', 'goal.limit': 'Round limit',
  'goal.created': 'Created', 'goal.updated': 'Updated',
  'goal.id': 'Goal ID', 'goal.revision': 'Revision',
  'goal.roundsHint': 'Rounds count admitted goal executions, not completion progress.',
  'goal.durableHint': 'Shows the goal state recorded by the host. Active does not mean automatic continuation is currently running.',
  'tab': 'Context',
