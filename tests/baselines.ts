...
export const BASELINES: readonly Baseline[] = [
  {
    // Session format V3 remains stable in 0.1.6-alpha.2. The release updates
    // the projection/session implementation and client services without
    // changing any seam consumed by this plugin.
    id: 'v0.1.6-alpha.2',
